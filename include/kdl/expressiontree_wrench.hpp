...
class Wrench_VectorVector : public BinaryExpression<Wrench, Vector, Vector> {
  public:
    Wrench_VectorVector() {
    }
    Wrench_VectorVector(const Expression<Vector>::Ptr& arg1, const Expression<Vector>::Ptr& arg2)
    ...
    virtual Expression<Wrench>::Ptr clone() {
        Expression<Wrench>::Ptr expr(new Wrench_VectorVector(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<Wrench>::Ptr wrench(Expression<KDL::Vector>::Ptr a, Expression<KDL::Vector>::Ptr b) {
    Expression<KDL::Wrench>::Ptr expr(new Wrench_VectorVector(a, b));
    return expr;
}

class Force_Wrench : public UnaryExpression<Vector, Wrench> {
  public:
  ...
  public:
    ...
    Force_Wrench(const Expression<Wrench>::Ptr& arg) : UnExpr("force", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<Vector>::Ptr expr(new Force_Wrench(argument->clone()));
        return expr;
    }
};

inline Expression<Vector>::Ptr force(Expression<Wrench>::Ptr a) {
    Expression<KDL::Vector>::Ptr expr(new Force_Wrench(a));
    return expr;
}

class Torque_Wrench : public UnaryExpression<Vector, Wrench> {
  public:
    typedef UnaryExpression<Vector, Wrench> UnExpr;
  ...
  public:
    ...
    Torque_Wrench(Expression<Wrench>::Ptr arg) : UnExpr("torque", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<Vector>::Ptr expr(new Torque_Wrench(argument->clone()));
        return expr;
    }
};

inline Expression<KDL::Vector>::Ptr torque(Expression<KDL::Wrench>::Ptr a) {
    Expression<KDL::Vector>::Ptr expr(new Torque_Wrench(a));
    return expr;
}

// Negate Wrench
class Negate_Wrench : public UnaryExpression<KDL::Wrench, KDL::Wrench> {
  public:
  ...
  public:
    ...
    Negate_Wrench(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("negation", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<KDL::Wrench>::Ptr expr(new Negate_Wrench(argument->clone()));
        return expr;
    }
};

inline Expression<KDL::Wrench>::Ptr operator-(Expression<KDL::Wrench>::Ptr a) {
    Expression<KDL::Wrench>::Ptr expr(new Negate_Wrench(a));
    return expr;
}

// Addition Wrench Wrench
class Addition_WrenchWrench : public BinaryExpression<KDL::Wrench, KDL::Wrench, KDL::Wrench> {
  public:
  ...
  public:
    ...
    Addition_WrenchWrench(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Wrench>::Ptr expr(new Addition_WrenchWrench(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<KDL::Wrench>::Ptr operator+(Expression<KDL::Wrench>::Ptr a1, Expression<KDL::Wrench>::Ptr a2) {
    Expression<KDL::Wrench>::Ptr expr(new Addition_WrenchWrench(a1, a2));
    return expr;
}

// Subtraction Wrench Wrench
class Subtraction_WrenchWrench : public BinaryExpression<KDL::Wrench, KDL::Wrench, KDL::Wrench> {
  public:
    typedef BinaryExpression<KDL::Wrench, KDL::Wrench, KDL::Wrench> BinExpr;
  ...
  public:
    ...
    Subtraction_WrenchWrench(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Wrench>::Ptr expr(new Subtraction_WrenchWrench(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<KDL::Wrench>::Ptr operator-(Expression<KDL::Wrench>::Ptr a1, Expression<KDL::Wrench>::Ptr a2) {
    Expression<KDL::Wrench>::Ptr expr(new Subtraction_WrenchWrench(a1, a2));
    return expr;
}

// Composition Rotation Wrench
class Composition_RotationWrench : public BinaryExpression<KDL::Wrench, KDL::Rotation, KDL::Wrench> {
  public:
  ...
  public:
    ...
    Composition_RotationWrench(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual KDL::Wrench derivative(int i) {
        ...
        return KDL::Wrench(arg1value * db.force + da * (arg1value * arg2value.force),
                           arg1value * db.torque + da * (arg1value * arg2value.torque));
    }
    virtual Expression<Wrench>::Ptr derivativeExpression(int i);

    virtual BinExpr::Ptr clone() {
        Expression<KDL::Wrench>::Ptr expr(new Composition_RotationWrench(argument1->clone(), argument2->clone()));
        return expr;
    }
};
...
class Multiplication_WrenchDouble : public BinaryExpression<KDL::Wrench, KDL::Wrench, double> {
  public:
  ...
  public:
    ...
    Multiplication_WrenchDouble(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Wrench>::Ptr expr(new Multiplication_WrenchDouble(argument1->clone(), argument2->clone()));
        return expr;
    }
};
...
class RefPoint_WrenchVector : public BinaryExpression<KDL::Wrench, KDL::Wrench, KDL::Vector> {
  public:
  ...
  public:
    ...
    RefPoint_WrenchVector(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual KDL::Wrench derivative(int i) {
        ...
        return KDL::Wrench(da.force, da.torque + da.force * arg2value + arg1value.force * argument2->derivative(i));
    }
    virtual Expression<Wrench>::Ptr derivativeExpression(int i);

    virtual BinExpr::Ptr clone() {
        Expression<KDL::Wrench>::Ptr expr(new RefPoint_WrenchVector(argument1->clone(), argument2->clone()));
        return expr;
    }
};
...
public:
    ...
    virtual KDL::Twist derivative(int i){ //TODO: Check implementation! The old implementation asserts false in the VV
case. return arg1value.Inverse(argument2->derivative(i));
    }
