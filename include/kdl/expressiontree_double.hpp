...
// +
class Addition_DoubleDouble : public BinaryExpression<double, double, double> {
  public:
  ...
  public:
    ...
    Addition_DoubleDouble(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Addition_DoubleDouble(argument1->clone(), argument2->clone()));
        return expr;
    }
};
...
// -
class Subtraction_DoubleDouble : public BinaryExpression<double, double, double> {
  public:
    typedef BinaryExpression<double, double, double> BinExpr;
  ...
  public:
    ...
    Subtraction_DoubleDouble(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Subtraction_DoubleDouble(argument1->clone(), argument2->clone()));
        return expr;
    }
};

// *
class Multiplication_DoubleDouble : public BinaryExpression<double, double, double> {
  public:
    typedef BinaryExpression<double, double, double> BinExpr;
    ...
    Multiplication_DoubleDouble(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Multiplication_DoubleDouble(argument1->clone(), argument2->clone()));
        return expr;
    }
};
...
// /
class Division_DoubleDouble : public BinaryExpression<double, double, double> {
  public:
    typedef BinaryExpression<double, double, double> BinExpr;
    ...
    Division_DoubleDouble(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Division_DoubleDouble(argument1->clone(), argument2->clone()));
        return expr;
    }
};
...
// atan2
class Atan2_DoubleDouble : public BinaryExpression<double, double, double> {
  public:
    typedef BinaryExpression<double, double, double> BinExpr;
    double                                           arg1value;
    double                                           arg2value;
  ...
  public:
    ...
    Atan2_DoubleDouble(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Atan2_DoubleDouble(argument1->clone(), argument2->clone()));
        return expr;
    }
};
...
// -
class Negate_Double : public UnaryExpression<double, double> {
  public:
  ...
  public:
    ...
    Negate_Double(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("negate", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Negate_Double(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr operator-(Expression<double>::Ptr a) {
    Expression<double>::Ptr expr(new Negate_Double(a));
    return expr;
}
...
// sin
class Sin_Double : public UnaryExpression<double, double> {
  public:
    typedef UnaryExpression<double, double> UnExpr;
    double                                  val;
  ...
  public:
    ...
    Sin_Double(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("sin", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Sin_Double(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr sin(Expression<double>::Ptr a) {
    Expression<double>::Ptr expr(new Sin_Double(a));
    return expr;
}

// cos
class Cos_Double : public UnaryExpression<double, double> {
  public:
    typedef UnaryExpression<double, double> UnExpr;
    double                                  val;
  ...
  public:
    ...
    Cos_Double(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("cos", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Cos_Double(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr cos(Expression<double>::Ptr a) {
    Expression<double>::Ptr expr(new Cos_Double(a));
    return expr;
}

// tan
class Tan_Double : public UnaryExpression<double, double> {
  public:
    typedef UnaryExpression<double, double> UnExpr;
  ...
  public:
    ...
    Tan_Double(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("tan", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Tan_Double(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr tan(Expression<double>::Ptr a) {
    Expression<double>::Ptr expr(new Tan_Double(a));
    return expr;
}

// asin
class Asin_Double : public UnaryExpression<double, double> {
  public:
    typedef UnaryExpression<double, double> UnExpr;
    double                                  val;
  ...
  public:
    ...
    Asin_Double(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("asin", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Asin_Double(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr asin(Expression<double>::Ptr a) {
    Expression<double>::Ptr expr(new Asin_Double(a));
    return expr;
}

// acos
class Acos_Double : public UnaryExpression<double, double> {
  public:
    typedef UnaryExpression<double, double> UnExpr;
    double                                  val;
  ...
  public:
    ...
    Acos_Double(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("acos", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Acos_Double(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr acos(Expression<double>::Ptr a) {
    Expression<double>::Ptr expr(new Acos_Double(a));
    return expr;
}

// exp
class Exp_Double : public UnaryExpression<double, double> {
  public:
    typedef UnaryExpression<double, double> UnExpr;
    double                                  val;
  ...
  public:
    ...
    Exp_Double(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("exp", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Exp_Double(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr exp(Expression<double>::Ptr a) {
    Expression<double>::Ptr expr(new Exp_Double(a));
    return expr;
}

// log
class Log_Double : public UnaryExpression<double, double> {
  public:
    typedef UnaryExpression<double, double> UnExpr;
    double                                  val;
  ...
  public:
    ...
    Log_Double(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("log", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Log_Double(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr log(Expression<double>::Ptr a) {
    Expression<double>::Ptr expr(new Log_Double(a));
    return expr;
}

// sqrt
class Sqrt_Double : public UnaryExpression<double, double> {
  public:
    typedef UnaryExpression<double, double> UnExpr;
    double                                  val;
  ...
  public:
    ...
    Sqrt_Double(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("sqrt", arg) {
    }
    virtual double value() {
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Sqrt_Double(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr sqrt(Expression<double>::Ptr a) {
    Expression<double>::Ptr expr(new Sqrt_Double(a));
    return expr;
}

// atan
class Atan_Double : public UnaryExpression<double, double> {
  public:
    typedef UnaryExpression<double, double> UnExpr;
    double                                  val;
  ...
  public:
    ...
    Atan_Double(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("atan", arg) {
    }
    virtual double value() {
        val = argument->value();
        return atan(val);
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Atan_Double(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr atan(Expression<double>::Ptr a) {
    Expression<double>::Ptr expr(new Atan_Double(a));
    return expr;
}

// abs
class Abs_Double : public UnaryExpression<double, double> {
  public:
    typedef UnaryExpression<double, double> UnExpr;
    double                                  val;
  ...
  public:
    ...
    Abs_Double(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("abs", arg) {
    }
    virtual double value() {
        val = argument->value();
        return fabs(val);
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Abs_Double(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr abs(Expression<double>::Ptr a) {
    Expression<double>::Ptr expr(new Abs_Double(a));
    return expr;
}

// fmod
class Fmod_Double : public UnaryExpression<double, double> {
  public:
    typedef UnaryExpression<double, double> UnExpr;
    double                                  denominator;
  ...
  public:
    ...
    Fmod_Double(const UnExpr::ArgumentExpr::Ptr& arg, double _denominator)
      : UnExpr("fmod", arg), denominator(_denominator) {
    }
    virtual double value() {
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Fmod_Double(argument->clone(), denominator));
        return expr;
    }
};

inline Expression<double>::Ptr fmod(Expression<double>::Ptr a, double b) {
    Expression<double>::Ptr expr(new Fmod_Double(a, b));
    return expr;
}

// sqrt
class Sqr_Double : public UnaryExpression<double, double> {
  public:
    typedef UnaryExpression<double, double> UnExpr;
    double                                  val;
  ...
  public:
    ...
    Sqr_Double(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("sqr", arg) {
    }
    virtual double value() {
        val = argument->value();
        return val * val;
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Sqr_Double(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr sqr(Expression<double>::Ptr a) {
    Expression<double>::Ptr expr(new Sqr_Double(a));
    return expr;
}

template <typename R>
class Conditional_double : public TernaryExpression<R, double, R, R> {
  public:
    bool condition;
    ...
    virtual typename Expression<typename AutoDiffTrait<R>::DerivType>::Ptr derivativeExpression(int i) {
        typename Expression<typename AutoDiffTrait<R>::DerivType>::Ptr expr(
            new Conditional_double<typename AutoDiffTrait<R>::DerivType>(
                this->argument1, this->argument2->derivativeExpression(i), this->argument3->derivativeExpression(i)));
        return expr;
    }
...
inline typename Expression<R>::Ptr conditional(typename Expression<double>::Ptr a1,
    ...
    if (vset.empty()) {
        ...
        typename Expression<R>::Ptr expr(new Conditional_double<R>(a1, a2, a3));
        return expr;
    }
}

template <typename R>
class NearZero_double : public TernaryExpression<R, double, R, R> {
  public:
    bool   condition;
    double tolerance;
    ...
    NearZero_double(typename Expression<double>::Ptr a1,
                    ...
                    typename Expression<R>::Ptr      a3,
                    double                           _tolerance)
      : TernaryExpression<R, double, R, R>("near_zero", a1, a2, a3), tolerance(_tolerance) {
    }
    ...
    virtual typename Expression<typename AutoDiffTrait<R>::DerivType>::Ptr derivativeExpression(int i) {
        typename Expression<typename AutoDiffTrait<R>::DerivType>::Ptr expr(
            new NearZero_double<typename AutoDiffTrait<R>::DerivType>(this->argument1,
    ...
    virtual typename Expression<R>::Ptr clone() {
        typename Expression<R>::Ptr expr(new NearZero_double(
            this->argument1->clone(), this->argument2->clone(), this->argument3->clone(), tolerance));
        return expr;
    }
};
 ...
 *
 * The user is responsible for the proper use of the function w.r.t. the derivatives.
 * - When the value is discontinuous when the condition is true then the derivative is not defined, only the left and
 * right limit of the derivative to the value.
 * - For a continuous derivative, the derivative of the 2nd argument and the 3th arguments should be the same when the
...
inline typename Expression<R>::Ptr near_zero(typename Expression<double>::Ptr a1,
                                             ...
                                             typename Expression<R>::Ptr      a2,
                                             typename Expression<R>::Ptr      a3) {
    typename Expression<R>::Ptr expr(new NearZero_double<R>(a1, a2, a3, tolerance));
    return expr;
}
...
template <class R>
class BlockWave : public UnaryExpression<R, double> {
  public:
    double period;
    R      level1;
    R      level2;
    ...
    virtual typename Expression<R>::Ptr clone() {
        typename Expression<R>::Ptr expr(new BlockWave<R>(this->argument->clone(), period, level1, level2));
        return expr;
    }
};

class BlockWave_double : public UnaryExpression<double, double> {
  public:
    double period;
    double level1;
    double level2;
    ...
    virtual Expression<double>::Ptr clone() {
        Expression<double>::Ptr expr(new BlockWave_double(this->argument->clone(), period, level1, level2));
        return expr;
    }
};
 ...
 */
template <class R>
inline typename Expression<R>::Ptr
blockwave(typename Expression<double>::Ptr a1, double period, const R& level1, const R& level2) {
    typename Expression<R>::Ptr expr(new BlockWave<R>(a1, period, level1, level2));
    return expr;
}
