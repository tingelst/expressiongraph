...
// Negate Twist
class Twist_VectorVector : public BinaryExpression<Twist, Vector, Vector> {
  public:
    Twist_VectorVector() {
    }
    Twist_VectorVector(const Expression<Vector>::Ptr& arg1, const Expression<Vector>::Ptr& arg2)
    ...
    virtual Expression<Twist>::Ptr clone() {
        Expression<KDL::Twist>::Ptr expr(new Twist_VectorVector(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<KDL::Twist>::Ptr twist(Expression<KDL::Vector>::Ptr a, Expression<KDL::Vector>::Ptr b) {
    Expression<KDL::Twist>::Ptr expr(new Twist_VectorVector(a, b));
    return expr;
}

// Negate Twist
class Negate_Twist : public UnaryExpression<KDL::Twist, KDL::Twist> {
  public:
  ...
  public:
    ...
    Negate_Twist(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("negation", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<KDL::Twist>::Ptr expr(new Negate_Twist(argument->clone()));
        return expr;
    }
};
inline Expression<KDL::Twist>::Ptr operator-(Expression<KDL::Twist>::Ptr a) {
    Expression<KDL::Twist>::Ptr expr(new Negate_Twist(a));
    return expr;
}

class Velocity_Twist : public UnaryExpression<Vector, Twist> {
  public:
  ...
  public:
    ...
    Velocity_Twist(const Expression<Twist>::Ptr& arg) : UnExpr("transvel", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<Vector>::Ptr expr(new Velocity_Twist(argument->clone()));
        return expr;
    }
};

inline Expression<Vector>::Ptr transvel(Expression<Twist>::Ptr a) {
    Expression<KDL::Vector>::Ptr expr(new Velocity_Twist(a));
    return expr;
}

class RotVelocity_Twist : public UnaryExpression<Vector, Twist> {
  public:
    typedef UnaryExpression<Vector, Twist> UnExpr;
    RotVelocity_Twist() {
    }
    RotVelocity_Twist(Expression<Twist>::Ptr arg) : UnExpr("rotvel", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<Vector>::Ptr expr(new RotVelocity_Twist(argument->clone()));
        return expr;
    }
};

inline Expression<KDL::Vector>::Ptr rotvel(Expression<KDL::Twist>::Ptr a) {
    Expression<KDL::Vector>::Ptr expr(new RotVelocity_Twist(a));
    return expr;
}

// Addition Twist Twist
class Addition_TwistTwist : public BinaryExpression<KDL::Twist, KDL::Twist, KDL::Twist> {
  public:
    typedef BinaryExpression<KDL::Twist, KDL::Twist, KDL::Twist> BinExpr;
    Addition_TwistTwist() {
    }
    Addition_TwistTwist(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Twist>::Ptr expr(new Addition_TwistTwist(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<KDL::Twist>::Ptr operator+(Expression<KDL::Twist>::Ptr a1, Expression<KDL::Twist>::Ptr a2) {
    Expression<KDL::Twist>::Ptr expr(new Addition_TwistTwist(a1, a2));
    return expr;
}

// Subtraction Twist Twist
class Subtraction_TwistTwist : public BinaryExpression<KDL::Twist, KDL::Twist, KDL::Twist> {
  public:
    typedef BinaryExpression<KDL::Twist, KDL::Twist, KDL::Twist> BinExpr;
    Subtraction_TwistTwist() {
    }
    Subtraction_TwistTwist(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Twist>::Ptr expr(new Subtraction_TwistTwist(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<KDL::Twist>::Ptr operator-(Expression<KDL::Twist>::Ptr a1, Expression<KDL::Twist>::Ptr a2) {
    Expression<KDL::Twist>::Ptr expr(new Subtraction_TwistTwist(a1, a2));
    return expr;
}

// Composition Rotation Twist
class Composition_RotationTwist : public BinaryExpression<KDL::Twist, KDL::Rotation, KDL::Twist> {
  public:
    ...
    Composition_RotationTwist(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual KDL::Twist derivative(int i) {
        ...
        return KDL::Twist(arg1value * db.vel + da * (arg1value * arg2value.vel),
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Twist>::Ptr expr(new Composition_RotationTwist(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<KDL::Twist>::Ptr operator*(Expression<KDL::Rotation>::Ptr a1, Expression<KDL::Twist>::Ptr a2) {
    Expression<KDL::Twist>::Ptr expr(new Composition_RotationTwist(a1, a2));
    return expr;
}

// Composition Twist Double
class Multiplication_TwistDouble : public BinaryExpression<KDL::Twist, KDL::Twist, double> {
  public:
    ...
    Multiplication_TwistDouble(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Twist>::Ptr expr(new Multiplication_TwistDouble(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<KDL::Twist>::Ptr operator*(Expression<KDL::Twist>::Ptr a1, Expression<double>::Ptr a2) {
    Expression<KDL::Twist>::Ptr expr(new Multiplication_TwistDouble(a1, a2));
    return expr;
}
inline Expression<KDL::Twist>::Ptr operator*(Expression<double>::Ptr a1, Expression<KDL::Twist>::Ptr a2) {
    Expression<KDL::Twist>::Ptr expr(new Multiplication_TwistDouble(a2, a1));
    return expr;
}

// RefPoint Twist Vector
class RefPoint_TwistVector : public BinaryExpression<KDL::Twist, KDL::Twist, KDL::Vector> {
  public:
    ...
    RefPoint_TwistVector(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual KDL::Twist derivative(int i) {
        ...
        return KDL::Twist(da.vel + da.rot * arg2value + arg1value.rot * argument2->derivative(i), da.rot);
    }

    virtual Expression<Twist>::Ptr derivativeExpression(int i);

    virtual BinExpr::Ptr clone() {
        Expression<KDL::Twist>::Ptr expr(new RefPoint_TwistVector(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<KDL::Twist>::Ptr ref_point(Expression<KDL::Twist>::Ptr a1, Expression<KDL::Vector>::Ptr a2) {
    Expression<KDL::Twist>::Ptr expr(new RefPoint_TwistVector(a1, a2));
    return expr;
}
