...
class Vector_DoubleDoubleDouble : public TernaryExpression<Vector, double, double, double> {
  public:
    Vector_DoubleDoubleDouble() {
    }
    Vector_DoubleDoubleDouble(Expression<double>::Ptr a1, Expression<double>::Ptr a2, Expression<double>::Ptr a3)
    ...
    virtual Vector derivative(int i) {
        return Vector(argument1->derivative(i), argument2->derivative(i), argument3->derivative(i));
    }
...
inline Expression<Vector>::Ptr vector(Expression<double>::Ptr a1,
    ...
    Expression<Vector>::Ptr expr(new Vector_DoubleDoubleDouble(a1, a2, a3));
    return expr;
}

// Dot vector vector
class Dot_VectorVector : public BinaryExpression<double, KDL::Vector, KDL::Vector> {
  public:
    ...
    Dot_VectorVector(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Dot_VectorVector(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr dot(Expression<KDL::Vector>::Ptr a1, Expression<KDL::Vector>::Ptr a2) {
    Expression<double>::Ptr expr(new Dot_VectorVector(a1, a2));
    return expr;
}

// Composition Vector Vector
class CrossProduct_VectorVector : public BinaryExpression<KDL::Vector, KDL::Vector, KDL::Vector> {
  public:
  ...
  public:
    ...
    CrossProduct_VectorVector(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Vector>::Ptr expr(new CrossProduct_VectorVector(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<KDL::Vector>::Ptr operator*(Expression<KDL::Vector>::Ptr a1, Expression<KDL::Vector>::Ptr a2) {
    Expression<KDL::Vector>::Ptr expr(new CrossProduct_VectorVector(a1, a2));
    return expr;
}
...
class Addition_VectorVector : public BinaryExpression<KDL::Vector, KDL::Vector, KDL::Vector> {
  public:
    typedef BinaryExpression<KDL::Vector, KDL::Vector, KDL::Vector> BinExpr;
  ...
  public:
    ...
    Addition_VectorVector(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Vector>::Ptr expr(new Addition_VectorVector(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<KDL::Vector>::Ptr operator+(Expression<KDL::Vector>::Ptr a1, Expression<KDL::Vector>::Ptr a2) {
    Expression<KDL::Vector>::Ptr expr(new Addition_VectorVector(a1, a2));
    return expr;
}

// Subtraction Vector Vector
class Subtraction_VectorVector : public BinaryExpression<KDL::Vector, KDL::Vector, KDL::Vector> {
  public:
    typedef BinaryExpression<KDL::Vector, KDL::Vector, KDL::Vector> BinExpr;
  ...
  public:
    ...
    Subtraction_VectorVector(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Vector>::Ptr expr(new Subtraction_VectorVector(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<KDL::Vector>::Ptr operator-(Expression<KDL::Vector>::Ptr a1, Expression<KDL::Vector>::Ptr a2) {
    Expression<KDL::Vector>::Ptr expr(new Subtraction_VectorVector(a1, a2));
    return expr;
}

// Negate Vector
class Negate_Vector : public UnaryExpression<KDL::Vector, KDL::Vector> {
  public:
  ...
  public:
    ...
    Negate_Vector(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("negate", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<KDL::Vector>::Ptr expr(new Negate_Vector(argument->clone()));
        return expr;
    }
};

inline Expression<KDL::Vector>::Ptr operator-(Expression<KDL::Vector>::Ptr a) {
    Expression<KDL::Vector>::Ptr expr(new Negate_Vector(a));
    return expr;
}

// Norm Vector
class SquaredNorm_Vector : public UnaryExpression<double, KDL::Vector> {
  public:
  ...
  public:
    ...
    SquaredNorm_Vector(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("squared_norm", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new SquaredNorm_Vector(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr squared_norm(Expression<KDL::Vector>::Ptr a) {
    Expression<double>::Ptr expr(new SquaredNorm_Vector(a));
    return expr;
}

// Norm Vector
class Norm_Vector : public UnaryExpression<double, KDL::Vector> {
  public:
    typedef UnaryExpression<double, KDL::Vector> UnExpr;
    KDL::Vector                                  val;
    double                                       nval;
  ...
  public:
    ...
    Norm_Vector(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("norm", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new Norm_Vector(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr norm(Expression<KDL::Vector>::Ptr a) {
    Expression<double>::Ptr expr(new Norm_Vector(a));
    return expr;
}

// Multiplication Vector Double
class Multiplication_VectorDouble : public BinaryExpression<KDL::Vector, KDL::Vector, double> {
  public:
  ...
  public:
    ...
    Multiplication_VectorDouble(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Vector>::Ptr expr(new Multiplication_VectorDouble(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<KDL::Vector>::Ptr operator*(Expression<KDL::Vector>::Ptr a1, Expression<double>::Ptr a2) {
    Expression<KDL::Vector>::Ptr expr(new Multiplication_VectorDouble(a1, a2));
    return expr;
}

inline Expression<KDL::Vector>::Ptr operator*(Expression<double>::Ptr a1, Expression<KDL::Vector>::Ptr a2) {
    Expression<KDL::Vector>::Ptr expr(new Multiplication_VectorDouble(a2, a1));
    return expr;
}

// CoordX Vector
class CoordX_Vector : public UnaryExpression<double, KDL::Vector> {
  public:
    typedef UnaryExpression<double, KDL::Vector> UnExpr;
  ...
  public:
    ...
    CoordX_Vector(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("coord_x", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new CoordX_Vector(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr coord_x(Expression<KDL::Vector>::Ptr a) {
    Expression<double>::Ptr expr(new CoordX_Vector(a));
    return expr;
}

// CoordY Vector
class CoordY_Vector : public UnaryExpression<double, KDL::Vector> {
  public:
    typedef UnaryExpression<double, KDL::Vector> UnExpr;
  ...
  public:
    ...
    CoordY_Vector(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("coord_y", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new CoordY_Vector(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr coord_y(Expression<KDL::Vector>::Ptr a) {
    Expression<double>::Ptr expr(new CoordY_Vector(a));
    return expr;
}

// CoordZ Vector
class CoordZ_Vector : public UnaryExpression<double, KDL::Vector> {
  public:
    typedef UnaryExpression<double, KDL::Vector> UnExpr;
  ...
  public:
    ...
    CoordZ_Vector(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("coord_z", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<double>::Ptr expr(new CoordZ_Vector(argument->clone()));
        return expr;
    }
};

inline Expression<double>::Ptr coord_z(Expression<KDL::Vector>::Ptr a) {
    Expression<double>::Ptr expr(new CoordZ_Vector(a));
    return expr;
}

// Diff Vector Vector
class Diff_VectorVector : public BinaryExpression<KDL::Vector, KDL::Vector, KDL::Vector> {
  public:
    typedef BinaryExpression<KDL::Vector, KDL::Vector, KDL::Vector> BinExpr;
  ...
  public:
    ...
    Diff_VectorVector(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Vector>::Ptr expr(new Diff_VectorVector(argument1->clone(), argument2->clone()));
        return expr;
    }
};
