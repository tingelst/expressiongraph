...
*/
class Frame_RotationVector : public BinaryExpression<Frame, Rotation, Vector> {
  public:
    Frame_RotationVector() {
    }
    Frame_RotationVector(Expression<Rotation>::Ptr a1, Expression<Vector>::Ptr a2)
    ...
    virtual Twist derivative(int i) {
        return Twist(argument2->derivative(i), argument1->derivative(i));
    }

    virtual Expression<Twist>::Ptr derivativeExpression(int i);

    virtual Expression<Frame>::Ptr clone() {
        Expression<Frame>::Ptr expr(new Frame_RotationVector(argument1->clone(), argument2->clone()));
        return expr;
    }
};

inline Expression<Frame>::Ptr frame(Expression<Rotation>::Ptr a1, Expression<Vector>::Ptr a2) {
    Expression<Frame>::Ptr expr(new Frame_RotationVector(a1, a2));
    return expr;
}

inline Expression<Frame>::Ptr frame(Expression<Rotation>::Ptr a1) {
    Expression<Frame>::Ptr expr(new Frame_RotationVector(a1, Constant(Vector::Zero())));
    return expr;
}

inline Expression<Frame>::Ptr frame(Expression<Vector>::Ptr a2) {
    Expression<Frame>::Ptr expr(new Frame_RotationVector(Constant(Rotation::Identity()), a2));
    return expr;
}

// Inverse Frame
class Inverse_Frame : public UnaryExpression<KDL::Frame, KDL::Frame> {
  public:
  ...
  public:
    ...
    Inverse_Frame(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("inv", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<KDL::Frame>::Ptr expr(new Inverse_Frame(argument->clone()));
        return expr;
    }
};

inline Expression<KDL::Frame>::Ptr inv(Expression<KDL::Frame>::Ptr a) {
    Expression<KDL::Frame>::Ptr expr(new Inverse_Frame(a));
    return expr;
}

// Composition Frame Frame
class Composition_FrameFrame : public BinaryExpression<KDL::Frame, KDL::Frame, KDL::Frame> {
  public:
  ...
  public:
    ...
    Composition_FrameFrame(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual KDL::Twist derivative(int i) {
        ...
        return KDL::Twist(da.rot * (arg1value.M * arg2value.p) + arg1value.M * db.vel + da.vel,
    ...
    virtual BinExpr::Ptr clone() {
        Expression<KDL::Frame>::Ptr expr(new Composition_FrameFrame(argument1->clone(), argument2->clone()));
        return expr;
    }
};
...
class Composition_FrameVector : public BinaryExpression<KDL::Vector, KDL::Frame, KDL::Vector> {
  public:
  ...
  public:
    ...
    Composition_FrameVector(const BinExpr::Argument1Expr::Ptr& arg1, const BinExpr::Argument2Expr::Ptr& arg2)
    ...
    virtual BinExpr::Ptr            clone() {
        Expression<KDL::Vector>::Ptr expr(new Composition_FrameVector(argument1->clone(), argument2->clone()));
        return expr;
    }
};
...
// Origin Frame
class Origin_Frame : public UnaryExpression<KDL::Vector, KDL::Frame> {
  public:
    typedef UnaryExpression<KDL::Vector, KDL::Frame> UnExpr;
    Origin_Frame() {
    }
    Origin_Frame(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("origin", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<KDL::Vector>::Ptr expr(new Origin_Frame(argument->clone()));
        return expr;
    }
};

inline Expression<KDL::Vector>::Ptr origin(Expression<KDL::Frame>::Ptr a) {
    Expression<KDL::Vector>::Ptr expr(new Origin_Frame(a));
    return expr;
}

// Rotation Frame
class Rotation_Frame : public UnaryExpression<KDL::Rotation, KDL::Frame> {
  public:
    typedef UnaryExpression<KDL::Rotation, KDL::Frame> UnExpr;
    Rotation_Frame() {
    }
    Rotation_Frame(const UnExpr::ArgumentExpr::Ptr& arg) : UnExpr("rotation", arg) {
    }
    ...
    virtual UnExpr::Ptr clone() {
        Expression<KDL::Rotation>::Ptr expr(new Rotation_Frame(argument->clone()));
        return expr;
    }
};

inline Expression<KDL::Rotation>::Ptr rotation(Expression<KDL::Frame>::Ptr a) {
    Expression<KDL::Rotation>::Ptr expr(new Rotation_Frame(a));
    return expr;
}
